...
public sealed class GDMENter.Addin : ReadySet.PostActAddin {

    ReadySet.Context context;
    ...
    public override async ReadySet.PostActStatusFlags run (ReadySet.Context context) throws Error {
        ...
        if (client == null) {
            ...
            yield log_user_in ();
            return ReadySet.PostActStatusFlags.STAY_OPEN;
        }
...
public void peas_register_types (TypeModule module) {
    ...
    obj.register_extension_type (typeof (ReadySet.PostActAddin), typeof (GDMENter.Addin));
}
