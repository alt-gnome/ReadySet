...
namespace Flatpak {
	...
	public class Installation : GLib.Object {
		...
		[Version (since = "1.9.1")]
		public GLib.GenericArray<weak Flatpak.InstalledRef> list_pinned_refs (string? arch, GLib.Cancellable? cancellable = null) throws GLib.Error;
		...
		public GLib.GenericArray<weak Flatpak.RelatedRef> list_remote_related_refs_for_installed_sync (string remote_name, string @ref, GLib.Cancellable? cancellable = null) throws GLib.Error;
		[Version (since = "0.6.7")]
		...
		[Version (since = "1.9.1")]
		public GLib.GenericArray<weak Flatpak.InstalledRef> list_unused_refs_with_options (string? arch, GLib.HashTable<void*,void*>? metadata_injection, GLib.Variant? options, GLib.Cancellable? cancellable = null) throws GLib.Error;
	...
	public class InstalledRef : Flatpak.Ref {
		...
		[Version (since = "1.4.2")]
		public unowned GLib.HashTable<string,string>? get_appdata_content_rating ();
		[Version (since = "1.4.2")]
	...
	public class Transaction : GLib.Object, GLib.Initable {
		...
		public bool add_install_image (string? image_location) throws GLib.Error;
		[Version (since = "1.3.3.")]
		...
		public bool add_rebase_and_uninstall (string remote, string new_ref, string old_ref, string? subpaths, [CCode (array_length = false, array_null_terminated = true)] string[]? previous_ids) throws GLib.Error;
		[Version (since = "1.7.1")]
		public bool add_sideload_image_collection (string location, GLib.Cancellable? cancellable = null) throws GLib.Error;
		[Version (since = "1.7.1")]
		public void add_sideload_repo (string path);
		public bool add_sync_preinstalled () throws GLib.Error;
		...
		[Version (since = "1.13.3")]
		public bool get_auto_install_debug ();
		[Version (since = "1.13.3")]
		public bool get_auto_install_sdk ();
		...
		[Version (since = "1.13.3")]
		public Flatpak.TransactionOperation get_operation_for_ref (string? remote, string @ref) throws GLib.Error;
		...
		[Version (since = "1.13.3")]
		public void set_auto_install_debug (bool auto_install_debug);
		[Version (since = "1.13.3")]
		public void set_auto_install_sdk (bool auto_install_sdk);
		...
		[Version (since = "1.13.0")]
		public bool no_interaction { get; set; }
