...
public sealed class ReadySet.ExistingUserFinalizer : Finalizer {

    public override async void run (ProgressData progress_data = new ProgressData ()) throws ApplyError {
