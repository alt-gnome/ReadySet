...
public class LicenseAgreement.Addin : ReadySet.StepAddin {
    ...
    public override HashTable<string, ReadySet.ContextVarInfo> get_context_vars () {
        ...
        vars["file-path"] = new ReadySet.ContextVarInfo (ReadySet.ContextType.STRING);
        vars["language-fallback"] = new ReadySet.ContextVarInfo (ReadySet.ContextType.STRING, "C");
        return vars;
    }
}
